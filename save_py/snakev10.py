...
snake_img = pygame.transform.scale(pygame.image.load('Images/assets/head.png'), (snake_block, snake_block))
...
def gameLoop():
    ...
    while not game_over:
        ...
        snake_rotated = pygame.transform.rotate(snake_img, 0)  # L'angle est fixé à 0
        snake_rect = snake_rotated.get_rect(center=(x1, y1))
        dis.blit(snake_rotated, snake_rect.topleft)
        snake_Head = [x1, y1]
